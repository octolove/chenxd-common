...
public class ESClientSpringFactory {
    ...
    public static ESClientSpringFactory build(HttpHost httpHost, Integer connectTimeOut, Integer socketTimeOut, Integer connectionRequestTime, Integer maxConnectNum,
    ...
    public void init() {
        ...
        logger.info(">>>>>init RestClient restHighLevelClient");
    }
